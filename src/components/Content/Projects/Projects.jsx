...
function Projects() {
  ...
  return (
    ...
    >
        ...
        <FeatProjectCard hovered={projectHover} name={'Vote to Play'} description={'Can´t decide what to play tonight? I´ve got you! After inputting an initial list of games, everyone gets to drag and drop the games in their order of preference. At the end it will calculate which game you should play.'} tags={['Redux', 'React', 'React-Bootstrap', 'DnD Kit']} linkLive={'https://vote-to-play.netlify.app/'} linkGithub={'https://github.com/Patchalv/vote-game-app_v4'} image={vote} /> 

        <FeatProjectCard hovered={projectHover} name={'Jamming Spotify Playlist Creator'} description={'The Jammming web app leverages the Spotify API to allow users to search for songs and create playlists, which can then be saved into their personal Spotify account.'} tags={['React', 'Spotify API', 'Netlify']} linkLive={'https://jammming-v3.netlify.app/'} linkGithub={'https://github.com/Patchalv/Jammming'} image={jammming} /> 
