function About() {
  return (
    <section data-section id="about" className='about-container sunHover'>
        ...
        <p>For the past 6+ years I´ve run a <a href="https://patrickalvarezwebdesign.com/">freelance web design company</a> whilst also <span className="bold">managing teams of up to a 150 people</span> in an educational company. A few months ago I finally chose to take the plunge and shift into focusing 100% on my real passion - <span className="bold">coding awesome stuff!</span></p>
